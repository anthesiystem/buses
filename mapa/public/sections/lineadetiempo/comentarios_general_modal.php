<?php
// /mapa/public/sections/lineadetiempo/comentarios_general_modal.php
session_start();
...
// Si es vista rápida, desactivar cache para cargar más rápido
if ($viewOnly) {
...
$defaultIcon = lt_default_icon_url();                      // helpers.php debe proveerlo
$publicIcons = lt_public_base_url() . '/icons';            // carpeta pública de íconos
?>
...
<div class="modal-content">
  ...
  <!-- Contenido: Stepper + Timeline (SIN formulario) -->
...
<script>
  // Filtro por etapa desde el stepper + autofiltro en etapa actual si existe.
  (function(){
    ...
    if (etapaActual && hayComentarios) {
      // Si NO hay comentarios de la etapa actual, mostramos todos; si sí hay, filtramos.
